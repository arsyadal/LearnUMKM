...
<html lang="en">
  ...
  <body class="bg-base-200">
    ...
    <div class="flex items-center justify-center mt-3">
        ...
        <div class="card-body">
          <ul class="steps">
            <li class="step">Manajemen Operasional</li>
            ...
            <div class="max-md">
                ...
                <div class="form-control">
                  ...
                  <div class="flex justify-center">
                    <a href="quisoner2.php" class="btn w-20 justify-center btn-sm mr-2">Sebelum</a>

                  <a href="quisoner4.php" class="btn btn-primary w-20 justify-center btn-sm">Sesudah</a>
