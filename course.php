...
<body>
    ...
    <!-- breadcrumbs -->
<h1 class="font-bold text-3xl ml-10">Lorem ipsum</h1>
...
<!-- breadcrumbs end -->
    ...
    <div class="carousel w-full mb-3">
        <div id="item1" class="carousel-item w-full justify-center">
          <img src="course landscape.png" class="w-full  mr-10 ml-10" style="height: 200px;" />
        </div> 
      </div> 
...
<!-- badge end -->
    ...
    <div class="card w-flex bg-base-100 shadow-xl ml-10 mr-10">
      <div class="card-body">
        <h2 class="card-title ">Nama Pemateri</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis distinctio officiis sapiente harum eaque quia pariatur voluptate quod excepturi architecto!</p>
    ...
    <p class="ml-10 mr-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis voluptatem quisquam veniam beatae aperiam obcaecati voluptates a ab sunt deserunt debitis architecto dolorem commodi, accusantium molestias aliquam excepturi facere eaque quam veritatis molestiae praesentium ullam quaerat! Temporibus mollitia ratione voluptate, porro labore molestias tempora hic aliquid vero. Laboriosam harum sint corporis obcaecati aut molestiae distinctio eveniet, aspernatur, officiis autem omnis?</p>
    ...
    <div class="card w-flex bg-base-100 shadow-xl ml-10 mr-10 mb-10">
      <div class="card-body">
        <h2 class="card-title">Modul 2</h2>
        <div class="flex ml-4">
          <div class="rounded-full h-8 w-8 bg-base-200 flex items-center justify-center">
            <!-- Icon di sini -->
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-presentation-analytics" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 12v-4" /><path d="M15 12v-2" /><path d="M12 12v-1" /><path d="M3 4h18" /><path d="M4 4v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-10" /><path d="M12 16v4" /><path d="M9 20h6" /></svg>
          </div>
          <p class="ml-2">Presentation Materi - Modul 2</p>
          <div class="form-control">
        ...
        <div class="flex ml-4">
          ...
          <p class="ml-2">        Post Test - Modul 2
          </p>
          <div class="form-control">
            <label class="label cursor-pointer gap-6">
              <input type="checkbox" check="check" class="checkbox" />
        ...
        <div class="card w-flex bg-base-100 shadow-xl ml-10 mr-10 mb-10">
            <div class="card-body">
            <h2 class="card-title">Modul 3</h2>
            <div class="flex ml-4">
              <div class="rounded-full h-8 w-8 bg-base-200 flex items-center justify-center">
                <!-- Icon di sini -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-presentation-analytics" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 12v-4" /><path d="M15 12v-2" /><path d="M12 12v-1" /><path d="M3 4h18" /><path d="M4 4v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-10" /><path d="M12 16v4" /><path d="M9 20h6" /></svg>
              </div>
              <p class="ml-2">Presentation Materi - Modul 3</p>
              <div class="form-control">
                <label class="label cursor-pointer gap-6">
                  <input type="checkbox" check="check" class="checkbox" />
                </label>
            ...
            <div class="flex ml-4">
              ...
              <p class="ml-2">        Post Test - Modul 3
              </p>
              <div class="form-control">
                <label class="label cursor-pointer gap-6">
                  <input type="checkbox" check="check" class="checkbox" />
